...
import { Save, Lock, Store, MapPin, Image, LogOut, Truck, Plus, Trash2, Globe, MessageCircle, Wallet, QrCode, ExternalLink, CheckCircle } from 'lucide-react';
              ...
              <div className="space-y-4 md:col-span-2">
                ...
                <div className="bg-red-50 p-4 rounded-lg border border-red-100">
                 ...
                 <div className="bg-blue-50 p-4 rounded-lg border border-blue-100">
                    <label className="block text-sm font-bold text-blue-800 mb-1">WhatsApp da Loja (Para receber pedidos)</label>
                    <input 
                        type="text" 
                    ...
                    <p className="text-xs text-blue-600 mt-2">
                        O número para onde os clientes enviarão a confirmação dos pedidos do cardápio digital.
                    </p>
                </div>
              </div>
