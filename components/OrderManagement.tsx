...
export const OrderManagement: React.FC<OrderManagementProps> = ({ orders, setOrders, settings, drivers }) => {
  ...
  const updateStatus = (orderId: string, newStatus: OrderStatus) => {
    // 1. Update the order status in the state
    setOrders(prev => prev.map(o => o.id === orderId ? { ...o, status: newStatus, updatedAt: new Date().toISOString() } : o));

    // 2. Logic to trigger WhatsApp Modal when moving to DELIVERING
        ...
        <html>
          ...
          <body>
            <div class="header">
              ...
              <div>Origem: ${order.source || 'LOJA'}</div>
            ...
            <div class="totals">
              ...
              <div style="margin-top:5px">Pagamento: <strong>${order.paymentMethod}</strong></div>
